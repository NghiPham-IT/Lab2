...
public class Presenter : IDisposable
{
    ...
    private async void Load()
    {
        ...
        try
        {
            var chapter = await domain.LoadChapter(cts.Token);
        ...
        {
            view.ShowErrorPanel("Opp! Something went wrong.");
            state = State.Error;
        }
    ...
    {
        zoomFactor += 0.1;
        view.SetPagePanelWidth(view.GetPageViewortWidth() * zoomFactor);
    }
    ...
    {
        zoomFactor = 1.0;
        view.SetPagePanelWidth(view.GetPageViewortWidth());
    }
